...
export const Skills = () => {
  const educations = [
    {
      name: "Cursos de Web Design, UX/UI Design, HTML, CSS, JavaScript, TS e React | Origamid",
    },
    {
      name: "Técnico em Informática para Internet | Etec Professora Maria Cristina Medeiros ",
    },
  ]
