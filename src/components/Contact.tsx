...
export function Contact() {
  ...
  const contacts = [
    {
      name: "WhatsApp",
      description: "+55 11 9.8558-5267",
      link: "https://wa.me/5511985585267?text=Olá...",
      icon: <FaWhatsapp className="h-10 w-10" />,
    },
    {
      name: "Email",
      description: "luisfelipeyoshi@gmail.com",
      link: "mailto:luisfelipeyoshi@gmail.com?subject=Olá...",
